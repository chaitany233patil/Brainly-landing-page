  ...
  return (
    <div className="flex flex-col items-center mt-20">
      ...
      >
        ...
        <span className="ml-2 italic">knowledge</span>
      </motion.div>
      <motion.p
        initial={{ opacity: 1, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        ...
        className="text-purple-100/70 text-lg sm:text-xl mt-8 text-center leading-6 sm:leading-7"
      >
      ...
      <div className="relative flex justify-center">
        ...
        <div className="lg:absolute mt-20 lg:mt-0 lg:top-28 grid grid-cols-1 md:grid-cols-2 gap-30">
